...
namespace Task3
{
    class Program
    {
        ...
        {
            Console.Write("Введите до какого числа искать: ");
            ...
            using (StreamReader read = new StreamReader("Fib.txt"))
            {
                ...
                Console.Write($"Числа фиббоначи от 0 до {n}:");
                Show(fibs);
                read.Dispose();
            }
            Console.WriteLine("\n"+new string('-',60));
            using (StreamReader read = new StreamReader("Prime.txt"))
            {
                ...
                Console.Write($"Простые числа от 0 до {n}:");
                Show(primes);
                read.Dispose();
            }
            ...
            Console.WriteLine($"Количество найденных простых чисел фиббоначи: {count}");
