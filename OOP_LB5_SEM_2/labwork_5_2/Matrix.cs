...
namespace labwork_5_2
{
    class Matrix
    {
        ...
        private Matrix CreateMatrixWithoutColumn(int column)
        {
            ...
            {
                Console.WriteLine("Ошибка индекса колонки");
            }
        ...
        private Matrix CreateMatrixWithoutRow(int row)
        {
            if (row < 0 || row >= Rows)
            {
                Console.WriteLine("Ошибка индекса строки");
            }
        ...
        public double CalculateDeterminant()
        {
            if (IsSquare() == false)
            {
                ...
                Console.WriteLine("Детерминант вычисляется только для квадратной матрицы");
                Console.ResetColor();
        ...
        public Matrix CreateInverseMatrix()
        {
            ...
            {
                Console.ForegroundColor = ConsoleColor.Yellow;
                Console.WriteLine("Обратная матрица существует только для квадратной");
                Console.ResetColor();
